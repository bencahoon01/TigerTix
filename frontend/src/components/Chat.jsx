...
const Chat = ({ onBuyTicket }) => {
    ...
    }, []); // setInputValue is guaranteed to be stable by React.
    ...
    useEffect(() => {
        ...
        // The event listener that receives the result from the Web Speech API.
        recognition.onresult = (event) => {
            const transcript = event.results[event.results.length - 1][0].transcript;
            onSpeechResult(transcript); // Call the stable callback to update state.
        };
